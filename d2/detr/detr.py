...
# 总结构，类似detectron2中的meta_arch文件夹中的内容
...
class Detr(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # 关于辅助loss Auxiliary decoding losses
        # We found helpful to use auxiliary losses in decoder during training
        # especially to help the model output the correct number of objects of each class
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            # 在这之前的box的尺寸是正常的，几十，几百的数字
            # 经过prepare_targets之后，都变成1以内
    ...
    def prepare_targets(self, targets):
        ...
        for targets_per_image in targets:
            ...
            # 因为不需要anchor的原因么，就不在需要知道很大的尺寸，也没有不同的特征层的stride的考虑
